...
export default function VaultClient() {
  ...
  useEffect(() => {
    async function loadVault() {
      ...
      const unlocked =
        localStorage.getItem(`nexo_unlocked_${cardCode}`) ||
        sessionStorage.getItem(`nexo_unlocked_${cardCode}`);
...
<div className="relative flex items-center justify-center pt-3">
  ...
  <Image
    ...
    height={320}
    priority
    className="relative z-10 w-[245px] sm:w-[315px] h-auto object-contain drop-shadow-[0_0_55px_rgba(255,106,0,0.55)] transition duration-500 hover:scale-[1.02]"
  />
</div>
</div>
</header>
              ...
              <div dir="rtl" className="min-w-0 flex-1">
                ...
                <div className="mt-4 space-y-3 text-sm leading-7 text-white/75">
                  <p className="flex items-start gap-2">
                    ...
                    <span>
                      بياناتك تُشفّر على جهازك قبل حفظها.
                    </span>
                  </p>
                  ...
                  <p className="flex items-start gap-2">
                    ...
                    <span>
                      حتى فريق NEXO لا يستطيع الاطلاع على محتوى حساباتك.
                    </span>
                  </p>
                </div>
              </div>
...
<section className="mb-5 overflow-hidden rounded-[30px] border border-orange-500/50 bg-gradient-to-br from-[#181818] via-[#111111] to-[#090909] p-5 shadow-[0_25px_60px_rgba(255,106,0,0.12)]">
  ...
  <div className="flex items-center justify-between">
    ...
    <div className="rounded-full bg-green-500/10 px-3 py-1 text-xs font-bold text-green-400 border border-green-500/20">
      ACTIVE
    </div>
  </div>
...
>
  ...
  <div className="relative flex min-w-0 items-center gap-4">
    ...
    <div className="min-w-0">
      ...
      <p className="mt-1 text-sm leading-6 text-white/50">
        عرض وإدارة جميع الحسابات الموجودة في خزنتك
      </p>
    </div>
  </div>
  ...
  <div className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-orange-500/20 bg-black/25 text-orange-500 transition duration-300 group-hover:-translate-x-1 group-hover:bg-orange-500/10">
    <HiOutlineArrowLeft size={24} />
         ...
         {/* شبكة التطبيقات */}
<section id="accounts" className="scroll-mt-6 mt-6">
    ...
    {apps.map((app) => {
      ...
      return (
        ...
        >
          ...
          <h4
            dir="ltr"
            className="truncate text-lg font-extrabold font-black text-white"
          >
            {app.name}
          </h4>
...
>
  ...
  <button
    ...
    disabled
    title="قريبًا"
    className="flex min-w-[58px] cursor-not-allowed flex-col items-center gap-1.5 text-white/30"
  >
